        ...
        <div className="text__au">
          <div className="p2">
            ...
            >
              ...
              atmosphere and high quality delicious food. We are proud providers
              of a variety of appetizers, delicious Afghan cuisine and unique
              presentation style service.
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div className="p2">
            <p style={{ fontFamily: "sans-serif", lineHeight: "30px" }}>
              ...
              source of our success, so we are always interested in serving
              them. We have updated our services with new products, highly
              qualified staff and smart managers. Balana Restaurant is your
              perfect choice for your family and friends.{" "}
            </p>
          </div>
        </div>
      </div>
